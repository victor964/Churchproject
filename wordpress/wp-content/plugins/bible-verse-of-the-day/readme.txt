...
Contributors: dailyverses,luckylab
...
Shows the daily inspiring Bible verse or a random Bible verse from DailyVerses.net. In English, Spanish, Portuguese, German, Italian, French, Dutch, Slovak, Finnish, Chinese (traditional) and Arabic.

== Description ==

This plugins shows a daily Bible verse or a random Bible verse from [DailyVerses.net](https://dailyverses.net). The plugin also supports [Spanish](https://dailyverses.net/es), [Portuguese](https://dailyverses.net/pt), [German](https://dailyverses.net/de), [Italian](https://dailyverses.net/it), [French](https://dailyverses.net/fr), [Polish](https://dailyverses.net/pl), [Dutch](https://dailyverses.net/nl), [Slovak](https://dailyverses.net/sk), [Czech](https://dailyverses.net/cs), [Finnish](https://dailyverses.net/fi), [Afrikaans](https://dailyverses.net/af), [Zulu](https://dailyverses.net/zu), [Russian](https://dailyverses.net/ru), [Chinese (traditional)](https://dailyverses.net/tc), [Bengali](https://dailyverses.net/bn) and [Arabic](https://dailyverses.net/ar) Bible verses. 
...
If the connection to [DailyVerses.net](https://dailyverses.net) for some reason fails, it will show the previous verse. If there is no previous verse, the plugin will show John 3:16.
...
Widget: 'Biblijny werset dnia' (Bible verse of the day) and 'Losowy werset Biblii' (Random Bible verse).
...
Widget: 'Biblický verš dne' (Bible verse of the day) and 'Náhodný Biblický verš' (Random Bible verse).
...
Widget: 'Bybelvers van die dag' (Bible verse of the day) and 'Willekeurig Bybelvers' (Random Bible verse).

**Zulu**

* Zulu Zulu 1959 (ZUL59)

Widget: 'Amavesi eBhayibheli osuku' (Bible verse of the day) and 'Ivesi leBhayibheli elingahleliwe' (Random Bible verse).

**Russian (Русский)**

* Синодальный перевод (RST)

Widget: 'Библейский стих дня' (Bible verse of the day) and 'Случайный стих из Библии' (Random Bible verse).
...
Widget: 'আজকের দিনের জন্য বাইবেল পদ' (Bible verse of the day) and 'র‌্যানড্ম বাইবেল পদ' (Random Bible verse).
...
3. - Widget: There are widgets added 'Bible Verse of the Day' and 'Random Bible Verse'. You can drag these onto the sidebar of your site, and select a bible translation.
...
* Added Italian - with the help of [Luciano Del Fico](https://lodeate.it)
...
* The widgets now have a option to choose whether you want to show the link to [DailyVerses.net](https://dailyverses.net) or not.

= 1.2 =
* On some wordpress installations there were security issues when getting the verse from [DailyVerses.net](https://dailyverses.net), these are now solved by using the wordpress functions.

= 1.1 =
* The new verse will now show at midnight depending on your server time, not the time of the server of [DailyVerses.net](https://dailyverses.net)
